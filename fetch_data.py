...
def fetch_scores_for_standings():
    ...
    try:
        ...
        for line in lines:
            ...
            if m:
                ...
                rows.append({'rank': int(rk), 'team': team,
    ...
    try:
        ...
        print(f"  → atplayertw 近期比賽：{len(results)} 場")

    except Exception as e:
        print(f"  ⚠️ atplayertw 近期比賽失敗: {e}")
