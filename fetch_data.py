...
def norm_venue(v):
    ...
    if '台大綜合' in v or '臺灣大學綜合' in v: return '台大體育館'
    if '天母' in v and '體育' in v: return '天母體育館'
...
def fetch_concerts():
    ...
    # 從 tickettw 抓新資料（共10頁，URL 格式為 /concerts/N）
    scraped = {}
    for page in range(1, 11):
        url = f'https://www.tickettw.com/concerts/{page}' if page > 1 else 'https://www.tickettw.com/concerts'
        try:
            soup = fetch_soup(url)
        except Exception as e:
